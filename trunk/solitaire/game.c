...
const unsigned char tileType[64] PROGMEM ={
...
const unsigned char* level_ptrs[25*2] PROGMEM ={
map1,palGameBG1,
map2,palGameBG1,
map3,palGameBG1,
map4,palGameBG1,
...
const unsigned char level_params[25*2] PROGMEM ={
2,0,//1
2,0,//2
0,0,//3
3,0,//4
...
const unsigned char code_str[6] PROGMEM ={BTN_B,BTN_LEFT,BTN_A,BTN_B,BTN_LEFT,BTN_A};

//stats and pause meta sprites

const unsigned char sprStats[] PROGMEM ={
...
const unsigned char sprPauseResume[] PROGMEM ={
0 ,0,0x6b,0,//r
8 ,0,0x84,0,//e
16,0,0x6c,0,//s
24,0,0x6e,0,//u
...
const unsigned char sprPauseRestart[] PROGMEM ={
0 ,8,0x6b,0,//r
8 ,8,0x84,0,//e
16,8,0x6c,0,//s
24,8,0x6d,0,//t
...
const unsigned char sprSoundTest[] PROGMEM ={
0 ,0,0x6c,3,//s
8 ,0,0x85,3,//f
16,0,0x7b,3,//x
48,0,0x81,3,//b
...
const unsigned char levelClear[] PROGMEM ={
...
void game_loop(void)
{
	...
	for(i=48;i<48+(MAP_HGT<<TILE_BIT);i+=TILE_SIZE)
	{
		for(j=0;j<MAP_WDT;j++)
		{
			...
			map[i16++]=pgm_read_byte(&tileType[spr]);
		}
	}
